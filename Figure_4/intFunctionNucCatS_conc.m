function mean_N_conc_eq = intFunctionNucCatS_conc(K_N_S,K_C2_N,ndays,div, cost)
...
for time=1:tmax
    t=t+1;
    dx = partFunctionNucCatS(x(t,:),K_N_S,K_C2_N, cost);
    dx_vector(t,:) = partFunctionNucCatS(x(t,:),K_N_S,K_C2_N, cost); %create a vector with all dxs
