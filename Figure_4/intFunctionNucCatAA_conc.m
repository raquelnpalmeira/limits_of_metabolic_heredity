function mean_N_conc_eq = intFunctionNucCatAA_conc(K_N_AA,K_C2_N, ndays,div, cost)
...
for time=1:tmax
    t=t+1;
    dx = partFunctionNucCatAA(x(t,:),K_N_AA,K_C2_N, cost);
    dx_vector(t,:) = partFunctionNucCatAA(x(t,:),K_N_AA,K_C2_N, cost); %create a vector with all dxs
